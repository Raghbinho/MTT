...
(function ($) {
    $.fn.EasyTree = function (options) {
        var defaults = {
            ...
            addable: false,
            i18n: {
                deleteNull: "S'il vous plaît sélectionner l'élément que vous souhaitez supprimer",
                deleteConfirmation: "Vous êtes sûr que vous voulez supprimer l'opération?",
                confirmButtonLabel: 'confirm',
                editNull: "S'il vous plaît sélectionner l'élément que vous souhaitez modifier.",
                editMultiple: 'Only one item can be edited at a time',
                addMultiple: 'Please choose an add',
                collapseTip: 'Put away the branch',
                expandTip: 'Put away the branch',
                selectTip: 'Select',
                unselectTip: 'Uncheck',
                editTip: 'Edit',
                addTip: 'Add',
